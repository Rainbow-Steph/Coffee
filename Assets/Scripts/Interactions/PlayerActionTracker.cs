...
public class PlayerActionTracker : ScriptableObject
{
    ...
    public System.Action<int> onLiquidAmountChanged;
    ...
    public int LiquidAmount
    {
        ...
        set
        {
            if (liquidAmount != value)
            {
                liquidAmount = value;
                onLiquidAmountChanged?.Invoke(liquidAmount);
            }
        }
    }
    ...
    /// <summary>
 /// Clears all tracker data (called on game start)
 /// </summary>
...
onLiquidAmountChanged?.Invoke(liquidAmount);
    ...
    {
        // Clear all data when the SO is loaded (game start)
        ClearAll();
